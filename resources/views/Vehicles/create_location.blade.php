    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('vehicles.storeLocation') }}" id="saveForm" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 pr-0">
                                <div class="form-group form-group-default">
                                    <label>Immatriculation du véhicule</label>
                                    <input type="text" value="{{ $vehicle->registration }}" disabled name="registration" required class="form-control"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group form-group-default">
                                    ...
                                    <input id="addName" type="date" name="location_date" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 pr-0">
                                <div class="form-group form-group-default">
                                    <label>Durée de l'emprunt</label>
                                    <input id="addPosition" type="number" name="duration" required class="form-control"
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group form-group-default">
                                    <label>Montant</label>
                                    <input id="addPosition" type="number" name="amount" required class="form-control"
