...
<body>
	<div class="wrapper">
		...
		<div class="quick-sidebar">
			<a href="index.html#" class="close-quick-sidebar">
				<i class="flaticon-cross"></i>
			</a>
			<div class="quick-sidebar-wrapper">
				<ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
					<li class="nav-item"> <a class="nav-link active show" data-toggle="tab" href="index.html#messages" role="tab" aria-selected="true">Messages</a> </li>
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="index.html#tasks" role="tab" aria-selected="false">Tasks</a> </li>
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="index.html#settings" role="tab" aria-selected="false">Settings</a> </li>
				</ul>
						...
						<div class="messages-wrapper">
							...
							<div class="messages-form">
								...
								<div class="messages-form-tool">
									<a href="index.html#" class="attachment">
										...
										<li>
											<label class="custom-checkbox custom-control checkbox-secondary">
												...
												<span class="task-action">
													<a href="index.html#" class="link text-danger">
